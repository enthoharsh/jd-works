  ...
  return (
    <Suspense fallback={<Loading cover="content"/>}>
      <Switch>
        ...
        <Route exact path={`${APP_PREFIX_PATH}/customer-management/customer-accounts/details/:id/inquiry-details/:id`} component={lazy(() => import(`./customer-management/customer-accounts/details/inquiry-details`))} />
        <Route exact path={`${APP_PREFIX_PATH}/customer-management/customer-accounts/details/:id/order-details/:id`} component={lazy(() => import(`./customer-management/customer-accounts/details/order-details`))} />
        ...
        <Route exact path={`${APP_PREFIX_PATH}/machine-and-sensors/sensor-list/add-new`} component={lazy(() => import(`./machine-and-sensor/add-new-sensor/index`))} />
