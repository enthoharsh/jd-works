...
const FlamePathDimension = ({ setModalName, auxilleryHeaterRadioChange, auxileryChecksHeater, setSRUploadForm, setSREditModal }) => {
    ...
    const data = ["Position A", "Position B", "Position C", "Position C1", "Position D", "Position E", "Position E1", "Position G", "Position H", "Position I", "Position J", "Position K", "Position L", "Position M", "Position P", "Position P1", "Position L1", "Position M1", "Position P2", "Position k1", "Position M2", "Position R"];
